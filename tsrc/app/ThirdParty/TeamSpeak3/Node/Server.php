...
class TeamSpeak3_Node_Server extends TeamSpeak3_Node_Abstract
{
  ...
  public function channelListObject(array $filter = array())
  {
    $object = new TeamSpeak3_Node_ChannelList();
    $channels = array_reverse($this->channelList());
    $object->buildFromArray($channels);
    return $object;
  }
